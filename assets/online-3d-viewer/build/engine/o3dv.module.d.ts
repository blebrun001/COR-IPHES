...
export function ConvertModelToThreeObject(model: any, conversionParams: any, conversionOutput: any, callbacks: any): void;
...
export function CreateHighlightMaterial(originalMaterial: any, highlightColor: any, withPolygonOffset: any): any;
export function CreateHighlightMaterials(originalMaterials: any, highlightColor: any, withPolygonOffset: any): any[];
...
export function CreateOcctWorker(worker: any): Promise<any>;
...
export function DotVector2D(a: any, b: any): number;
...
export function FLoc(str: any, ...args: any[]): any;
...
export function FormatString(template: any, ...args: any[]): any;
...
export function GetDefaultMaterials(model: any): any[];
...
export function GetLineSegmentsProjectedDistance(camera: any, canvasWidth: any, canvasHeight: any, lineSegments: any, screenPoint: any): number;
...
export class Importer3dm extends ImporterBase {
    ...
    ImportRhinoGeometryAsMesh(rhinoDoc: any, rhinoGeometry: any, rhinoObject: any, rhinoInstanceReferences: any): any;
...
export class ImporterObj extends ImporterBase {
    ...
    ProcessLineCommand(parameters: any): void;
    ProcessFaceCommand(parameters: any): void;
    GetRelativeIndex(index: any, count: any): any;
}
...
export namespace IntersectionMode {
    let MeshOnly: number;
    let MeshAndLine: number;
}
export function IsDefined(val: any): boolean;
export function IsDomElementVisible(element: any): boolean;
export function IsEmptyMesh(mesh: any): boolean;
...
export function LoadExternalLibrary(libraryName: any): Promise<any>;
export function LoadExternalLibraryFromUrl(libraryUrl: any): Promise<any>;
export function Loc(str: any): any;
...
export namespace MaterialGeometryType {
    let Line: number;
    let Face: number;
}
export namespace MaterialSource {
    let Model: number;
    let DefaultFace: number;
...
export class Mesh extends ModelObject3D {
    ...
    AddLine(line: any): number;
    GetLine(index: any): any;
...
export class ParameterListBuilder {
    ...
    AddDefaultLineColor(color: any): this;
...
export function ProjectPointToSegment2D(segment: any, point: any): any;
/**
...
export function ReplaceDefaultMaterialsColor(model: any, color: any, lineColor: any): void;
...
export function SegmentPointDistance2D(segment: any, point: any): number;
...
export function SetLanguageCode(languageCode: any): void;
export function SetLocalizedStrings(localizedStrings: any): void;
...
export class ThreeMaterialHandler {
    constructor(model: any, stateHandler: any, conversionParams: any, conversionOutput: any);
    model: any;
    stateHandler: any;
    conversionParams: any;
    conversionOutput: any;
    shadingType: number;
    modelToThreeLineMaterial: Map<any, any>;
    modelToThreeMaterial: Map<any, any>;
    GetThreeMaterial(modelMaterialIndex: any, geometryType: any): any;
    CreateThreeFaceMaterial(materialIndex: any): any;
    CreateThreeLineMaterial(materialIndex: any): any;
    LoadFaceTexture(threeMaterial: any, texture: any, onTextureLoaded: any): void;
}
export class ThreeMeshMaterialHandler {
    constructor(threeGeometry: any, geometryType: any, materialHandler: any);
    threeGeometry: any;
    geometryType: any;
    materialHandler: any;
    itemVertexCount: number;
    meshThreeMaterials: any[];
    meshOriginalMaterials: any[];
    groupStart: any;
    previousMaterialIndex: any;
    ProcessItem(itemIndex: any, materialIndex: any): void;
    Finalize(itemCount: any): void;
    AddGroup(start: any, end: any): void;
}
export class ThreeModelLoader {
    ...
    GetDefaultMaterials(): any[];
    ReplaceDefaultMaterialsColor(defaultColor: any, defaultLineColor: any): void;
...
export class Viewer {
    ...
    GetMeshUserDataUnderMouse(intersectionMode: any, mouseCoords: any): any;
    GetMeshIntersectionUnderMouse(intersectionMode: any, mouseCoords: any): any;
    GetBoundingBox(needToProcess: any): any;
    GetBoundingSphere(needToProcess: any): any;
    EnumerateMeshesAndLinesUserData(enumerator: any): void;
    InitNavigation(): void;
    InitShading(): void;
...
export class ViewerMainModel {
    ...
    EnumerateLines(enumerator: any): void;
    EnumerateMeshesAndLines(enumerator: any): void;
    EnumerateEdges(enumerator: any): void;
    HasLinesOrEdges(): boolean;
    UpdatePolygonOffset(): void;
    GetMeshIntersectionUnderMouse(intersectionMode: any, mouseCoords: any, camera: any, width: any, height: any): any;
}
